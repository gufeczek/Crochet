...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>vosk</b> with <b>com.alphacephei:vosk-android</b> coordinates and
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>arrow</b> with value <b>2.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class KoinVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>koin.annotations</b> with value <b>2.0.0-Beta3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>koin.bom</b> with value <b>4.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final ConventionPluginAccessors paccForConventionPluginAccessors = new ConventionPluginAccessors(providers, config);
        ...
        /**
         * Group of plugins at <b>plugins.convention</b>
         */
        public ConventionPluginAccessors getConvention() {
            return paccForConventionPluginAccessors;
        }
    ...
    public static class ConventionPluginAccessors extends PluginFactory {

        public ConventionPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>convention.feature</b> with plugin id <b>crochet.convention.feature</b> and
         * with <b>no version specified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getFeature() { return createPlugin("convention.feature"); }
